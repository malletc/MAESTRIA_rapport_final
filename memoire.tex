...
\begin{figure}
  ...
  \begin{tikzpicture}
    \begin{groupplot}[group style={group size=2 by 2,
        ...
        small, no markers, grid,xlabel={Jour de l'année}, ylabel={NDVI},
        xmin=0, xmax=350, ymin=0.15, ymax=0.9,
        width=0.475\linewidth, height=0.275\linewidth]
      \nextgroupplot[smooth, title={Classe}]
      \addplot[name path=CP,black!25]
      table [col sep=comma, x=dates, y=mean_class_pstd]{ndvi_mean_val.csv};
      \addplot[name path=CM, black!25] table[col sep=comma, x=dates, y=mean_class_mstd]{ndvi_mean_val.csv};
      \addplot[black!25] fill between[of=CP and CM];
      \addplot[very thick, black] table[col sep=comma, x=dates, y=mean_class]{ndvi_mean_val.csv};

      \nextgroupplot[smooth, title={Premier cluster}]
      \addplot[name path=CP,red!25]
      table [col sep=comma, x=dates, y=mean_K1_pstd]{ndvi_mean_val.csv};
      \addplot[name path=CM,red!25] table[col sep=comma, x=dates, y=mean_K1_mstd]{ndvi_mean_val.csv};
      \addplot[red!25] fill between[of=CP and CM];
      \addplot[very thick, red] table[col sep=comma, x=dates, y=mean_K1]{ndvi_mean_val.csv};

      \nextgroupplot[smooth, title={Deuxième cluster}]
      \addplot[name path=CP,blue!25]
      table [col sep=comma, x=dates, y=mean_K2_pstd]{ndvi_mean_val.csv};
      \addplot[name path=CM,blue!25] table[col sep=comma, x=dates, y=mean_K2_mstd]{ndvi_mean_val.csv};
      \addplot[blue!25] fill between[of=CP and CM];
      \addplot[very thick, blue] table[col sep=comma, x=dates, y=mean_K2]{ndvi_mean_val.csv};

      \nextgroupplot[smooth, title={Troisième cluster}]
      \addplot[name path=CP,magenta!25]
      table [col sep=comma, x=dates, y=mean_K3_pstd]{ndvi_mean_val.csv};
      \addplot[name path=CM,magenta!25] table[col sep=comma, x=dates, y=mean_K3_mstd]{ndvi_mean_val.csv};
      \addplot[magenta!25] fill between[of=CP and CM];
      \addplot[very thick, magenta] table[col sep=comma, x=dates, y=mean_K3]{ndvi_mean_val.csv};      
    \end{groupplot}
\end{tikzpicture}
  \caption{Profil moyen pour la classe \emph{tournesol} (jeu de données NDVI \cite{pelletier2017effect}) et ses moyennes associées aux clusters estimées avec RMDA (ligne continue fine). Les régions autour correspondent à la moyenne \(\pm\) l'écart-type. Voir \cite{GIRYFOUQUET2021320} pour plus de détails.}
  \label{fig:ndvi:sunflower}
\end{figure}
